...
export default function ContactForm() {
  ...
  return (
    <div className="min-h-screen bg-[#024149] flex items-center justify-center p-4">
      <div className="w-full max-w-[862px] min-h-[613px] bg-[#024149] rounded-[14px] relative flex flex-col lg:flex-row">
        {/* Left Section */}
        <div className="p-10 text-[#EEEEEE] lg:w-1/2">
          <h1 className="text-2xl md:text-[28px] font-bold leading-tight mb-16">
            Let&apos;s discuss on something <span className="text-[#148594]">cool</span> together
          </h1>

          <div className="space-y-4 mb-16">
            <div className="flex items-center gap-3">
              <EnvelopeIcon className="w-4 h-4 text-[#148594]" />
              <span className="text-sm">SaulDesign@gmail.com</span>
            </div>
            <div className="flex items-center gap-3 bg-[rgba(87,10,87,0.5)] border border-[#148594] p-4 rounded-lg">
              <PhoneIcon className="w-4 h-4 text-[#148594]" />
              <span className="text-sm">+123 456 789</span>
            </div>
            <div className="flex items-center gap-3">
              <MapPinIcon className="w-4 h-4 text-[#148594]" />
              <span className="text-sm">123 Street 456 House</span>
            </div>
          </div>

          <div className="flex gap-4">
            <Link href="https://www.facebook.com/" target='_blank' className="w-10 h-10 bg-[#148594] rounded-full flex items-center justify-center">
              <span className="sr-only">Facebook</span>
              <svg className="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 24 24">
                <path d="M9 8h-3v4h3v12h5v-12h3.642l.358-4h-4v-1.667c0-.955.192-1.333 1.115-1.333h2.885v-5h-3.808c-3.596 0-5.192 1.583-5.192 4.615v3.385z" />
              </svg>
            </Link>
            <Link href="https://www.instagram.com/" target='_blank' className="w-10 h-10 bg-[#148594] rounded-full flex items-center justify-center">
              ...
              <div className="space-y-6">
                <div className="space-y-1">
                  <Input
                    ...
                    className="border-0 border-b-2 border-[#148594] rounded-none px-0 focus-visible:ring-0"
                ...
                <Button type='submit' className="bg-[#148594] hover:bg-[#148581]/90 text-white mt-14">
